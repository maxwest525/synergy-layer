...
| Title element    | Accurate query and task recognition                   | rendered title, GSC page/query rows, relevant stored SERP evidence      | qualified CTR at comparable position       | title/H1 core `IMPLEMENTED`; adapter `DESIGNED` |
...
| H1               | One truthful primary page promise                     | exactly one rendered H1, page copy, GSC and relevant SERP evidence      | comprehension and relevant coverage        | title/H1 core `IMPLEMENTED`; adapter `DESIGNED` |

...
State: `IMPLEMENTED` locally and covered by tests. Database enforcement and historical repair are in an unapplied local migration, so deployed enforcement is `EXTERNAL`.

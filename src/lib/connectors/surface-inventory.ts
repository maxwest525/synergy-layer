  ...
  },
  {
    ...
    operations: [
      ...
      op({
        ...
        status: "wired",
        evidence: "src/lib/page-audit.server.ts",
        gap: "Still limited to the TruMove origin. The page audit now renders here first and falls back to the metered Firecrawl only when this box is unconfigured or fails, recording which renderer read each page.",
      }),
    ],
  },
  {
